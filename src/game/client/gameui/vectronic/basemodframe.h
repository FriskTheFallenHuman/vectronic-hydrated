...
namespace BaseModUI {
	...
	public:
		...
		int  DrawSmearBackground( int x, int y, int wide, int tall );
		int	 DrawSmearBackgroundFade( int x, int y, int wide, int tall, float f1, float f2  );
		int	 DrawBlackBackground( int x, int y, int wide, int tall );
