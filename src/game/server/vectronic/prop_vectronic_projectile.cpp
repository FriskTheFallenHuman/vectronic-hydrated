...
//Tails
#define PROP_PARTICLE_SPRITE0_TRAIL "effects/ball_blue_tape.vmt" 
#define PROP_PARTICLE_SPRITE1_TRAIL "effects/ball_green_tape.vmt" 
#define PROP_PARTICLE_SPRITE2_TRAIL "effects/ball_purple_tape.vmt"
#define PROP_PARTICLE_SPRITE3_TRAIL "effects/ball_red_tape.vmt"

// Community Ball Tails
//#define PROP_PARTICLE_SPRITE4_TRAIL "effects/ball_yellow_tape.vmt"
//#define PROP_PARTICLE_SPRITE5_TRAIL "effects/ball_orange_tape.vmt"

//Particles
#define PROP_PARTICLE_BALL_PARTICLE0	"projectile_ball_blue"
#define PROP_PARTICLE_BALL_PARTICLE1	"projectile_ball_green"
#define PROP_PARTICLE_BALL_PARTICLE2	"projectile_ball_purple"
#define PROP_PARTICLE_BALL_PARTICLE3	"projectile_ball_red"

// Community Ball Particles
//#define PROP_PARTICLE_BALL_PARTICLE4	"projectile_ball_yellow"
//#define PROP_PARTICLE_BALL_PARTICLE5	"projectile_ball_orange"

//Particles Used To Explode
#define PROP_PARTICLE_BALL_HIT0		"vecgun_blue_charge_glow"
#define PROP_PARTICLE_BALL_HIT1		"vecgun_green_charge_glow"
#define PROP_PARTICLE_BALL_HIT2		"vecgun_purple_charge_glow"
#define PROP_PARTICLE_BALL_HIT3		"vecgun_red_charge_glow"

// Community Ball
//#define PROP_PARTICLE_BALL_HIT4		"vecgun_yellow_charge_glow"
//#define PROP_PARTICLE_BALL_HIT5		"vecgun_orange_charge_glow"
...
BEGIN_DATADESC( CPropParticleBall )
	...
	DEFINE_FIELD( m_intCType,	FIELD_INTEGER ),
...
IMPLEMENT_SERVERCLASS_ST( CPropParticleBall, DT_PropParticleBall )
	...
	SendPropBool( SENDINFO( m_intCType ) ),
...
void CPropParticleBall::Precache( void )
{
	...
	PrecacheModel( PROP_PARTICLE_SPRITE3_TRAIL );

	//PrecacheModel( PROP_PARTICLE_SPRITE4_TRAIL );
	//PrecacheModel( PROP_PARTICLE_SPRITE5_TRAIL );

#ifndef NO_PARTICLE_EFFECTS
{
	PrecacheParticleSystem( PROP_PARTICLE_BALL_PARTICLE0 );
	PrecacheParticleSystem( PROP_PARTICLE_BALL_PARTICLE1 );
	PrecacheParticleSystem( PROP_PARTICLE_BALL_PARTICLE2 );
	PrecacheParticleSystem( PROP_PARTICLE_BALL_PARTICLE3 );

	//PrecacheParticleSystem( PROP_PARTICLE_BALL_PARTICLE4 );
	//PrecacheParticleSystem( PROP_PARTICLE_BALL_PARTICLE5 );

	PrecacheParticleSystem( PROP_PARTICLE_BALL_HIT0 );
	PrecacheParticleSystem( PROP_PARTICLE_BALL_HIT1 );
	PrecacheParticleSystem( PROP_PARTICLE_BALL_HIT2 );
	PrecacheParticleSystem( PROP_PARTICLE_BALL_HIT3 );

	//PrecacheParticleSystem( PROP_PARTICLE_BALL_HIT4 );
	//PrecacheParticleSystem( PROP_PARTICLE_BALL_HIT5 );
...
void CPropParticleBall::GetTail()
{
	...
	if ( m_intType == 0 )
	{
		m_pGlowTrail = CSpriteTrail::SpriteTrailCreate( PROP_PARTICLE_SPRITE0_TRAIL, GetAbsOrigin(), false );
	}

	if ( m_intType == 1 )
	{
		m_pGlowTrail = CSpriteTrail::SpriteTrailCreate( PROP_PARTICLE_SPRITE1_TRAIL, GetAbsOrigin(), false );
	}

	if ( m_intType == 2 )
	{
		m_pGlowTrail = CSpriteTrail::SpriteTrailCreate( PROP_PARTICLE_SPRITE2_TRAIL, GetAbsOrigin(), false );
	}

	if ( m_intType == 3 )
	{
		m_pGlowTrail = CSpriteTrail::SpriteTrailCreate( PROP_PARTICLE_SPRITE3_TRAIL, GetAbsOrigin(), false );
	}

	/*
	if ( m_intType == 4 )
	{
		m_pGlowTrail = CSpriteTrail::SpriteTrailCreate( PROP_PARTICLE_SPRITE4_TRAIL, GetAbsOrigin(), false );
	}
...
void CPropParticleBall::SetType( int inttype )
{
	...
	if ( inttype == 0 )
	{
		...
		// Particle Effects. CALL JUNIOR TO TAKE A LOOK SOMETIME!
#ifndef NO_PARTICLE_EFFECTS
{
		DispatchParticleEffect (PROP_PARTICLE_BALL_PARTICLE0, PATTACH_ABSORIGIN_FOLLOW, this );
}
#endif
		// Tell the Server we are Blue
		m_intType = 0;

		// Call Tail
		GetTail();

		// Tell the Client we are Blue
		m_intCType = 0;
	}
...
#ifndef NO_PARTICLE_EFFECTS
{
		DispatchParticleEffect (PROP_PARTICLE_BALL_PARTICLE1, PATTACH_ABSORIGIN_FOLLOW, this );
}
#endif	
		// Tell the Server we are Green
		m_intType = 1;

		// Call Tail
		GetTail();

		// Tell the Client we are Green
		m_intCType = 1;
	}
...
#ifndef NO_PARTICLE_EFFECTS
{
		DispatchParticleEffect (PROP_PARTICLE_BALL_PARTICLE2, PATTACH_ABSORIGIN_FOLLOW, this );
}
#endif
		// Tell the Server we are Purple
		m_intType = 2;

		// Call Tail
		GetTail();

		// Tell the Client we are Purple
		m_intCType = 2;
	}
...
#ifndef NO_PARTICLE_EFFECTS
{
		DispatchParticleEffect (PROP_PARTICLE_BALL_PARTICLE3, PATTACH_ABSORIGIN_FOLLOW, this );
}
#endif
		// Tell the Server we are Red
		m_intType = 3;

		// Call Tail
		GetTail();

		// Tell the Client we are Red
		m_intCType = 3;
	}
	/*
	if ( inttype == 4 )
...
#ifndef NO_PARTICLE_EFFECTS
{
		DispatchParticleEffect (PROP_PARTICLE_BALL_PARTICLE4, PATTACH_ABSORIGIN_FOLLOW, this );
}
#endif
		// Tell the Server we are Red
		m_intType = 4;
...
#ifndef NO_PARTICLE_EFFECTS
{
		DispatchParticleEffect (PROP_PARTICLE_BALL_PARTICLE5, PATTACH_ABSORIGIN_FOLLOW, this );
}
#endif
		// Tell the Server we are Red
		m_intType = 5;
...
void CPropParticleBall::DoImpactEffect( const Vector &preVelocity, int index, gamevcollisionevent_t *pEvent )
{
	...
	if ( tr.fraction < 1.0f )
	{
		...
		if ( tr.surface.flags & SURF_SKY )
		{
			...
			if (m_intType == 3) 
			{
				DispatchEffect( "cball_red_bounce", data );
			}
/*
			if (m_intType == 4) 
			{
				DispatchEffect( "cball_yellow_bounce", data );
			}

			if (m_intType == 5) 
			{
				DispatchEffect( "cball_orange_bounce", data );
			}
*/
...
//	if ( pHitEntity->GetCollisionGroup() == COLLISION_GROUP_BALLTARGET )
	{
		m_bHitBox = true;
		DoExplosion();
